...
<div class="card">
    ...
    <div class="col s6"><h4 style="text-align: center">Pedidos Compra</h4>
        <div id="chartcompra"></div>
    </div>

    <div class="col s6"><h4 style="text-align: center">Pedidos Venda</h4>
    ...
    <div class="col s6"><h4 style="text-align: center">Fornecedores</h4>
  ...
  <div class="card">
    <div class="row">
    <div class="col s6"><h4 style="text-align: center">Produtos</h4>
...
new Morris.Line({
  ...
  data: [
    @foreach($pedidocomprabar as $sale)
         {'x': '{{ $sale->mes }}/{{$sale->ano}}', 'y': '{{ $sale->contadorpreco }}'},
     @endforeach
  ],
