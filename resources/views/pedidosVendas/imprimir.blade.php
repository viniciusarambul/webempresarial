...
<main>
  ...
  <h1 align="center">Pedido Venda {{$pedidoVenda->id}}</h1>
      <table style="width: 100% !important">
        ...
        <tr>
              ...
              <td style="text-align: center">{{ date('d/m/Y', strtotime($pedidoVenda->data)) }}</td>
              <td style="text-align: right">{{ isset($pedidoVenda->nome) ? $pedidoVenda->nome : 'Nenhuma' }}</td>
              <td style="text-align: center"> {{$pedidoVenda->situacao_descricao}} </td>
              <td style="text-align: center">{{ $pedidoVenda->clientes->nome }}</td>
              <td style="text-align: center">{{ $pedidoVenda->vendedores->nome }}</td>
    ...
    <table align="center">
        ...
        <tr>
            ...
            <td colspan="1">R$ {{number_format($pedidoVenda->totalpreco, 2, ',', '.')}}</td>
        </tr>
        </tbody>
    </table>
    ...
    <table align="center">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: right">{{ number_format($pedidoVenda->titulo->preco,2,',','.') }}</td>
